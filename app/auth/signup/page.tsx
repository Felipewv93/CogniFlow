      ...
      <div className="w-full max-w-md p-8">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg border px-4 py-2 transition hover:bg-muted/50"
          >
            {/* Google Icon */}
            <svg
              width="20"
        ...
        <div className="mt-8 rounded-lg bg-muted/50 p-4">
          <p className="flex flex-wrap items-center justify-center gap-2 text-center text-xs text-muted-foreground">
